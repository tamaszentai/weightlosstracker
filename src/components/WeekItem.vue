          ...
          <div class="my-4">
              ...
              <table class="min-w-full divide-y divide-gray-300">
                  ...
                  <tr v-for="day in weekData.days" :key="day.date">
                      <td><span class="text-sm font-medium text-gray-900">{{ day.date.toDate().toDateString() }}</span></td>
                      <td v-if="typeof day.weight !== 'string'" class="text-right"><span class="text-sm text-gray-500">{{ day.weight }}kg</span></td>
                  </tr>
                  </tbody>
              </table>
          </div>
