  ...
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" @submit.prevent="login">
        ...
        <div>
          <div class="flex items-center justify-between">
            ...
            <div class="text-sm">
              <a href="#" class="font-semibold text-green-500 hover:text-black">Forgot password?</a>
            </div>
          </div>
          <div class="mt-2">
        ...
        <div>
          <button type="submit" class="flex w-full justify-center rounded-md bg-green-500 text-black px-3 py-1.5 text-sm font-semibold leading-6 shadow-sm hover:bg-green-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-300">Sign in</button>
        </div>
      </form>
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        Not a member?
        {{ ' ' }}
        <RouterLink to="/register" class="font-semibold leading-6 text-green-500  hover:text-black">Click here to register</RouterLink>
      </p>
    </div>
  </div>
</template>
